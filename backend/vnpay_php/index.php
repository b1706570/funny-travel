    ...
    <body>
        ...
        <div class="container">
            <h2>Thông tin chuyến đi</h2>
                <div class="div-top">
                    <div class="row">
                        <div class="col-left">Tên khách sạn:</div>
                        <div class="col-right"><?php echo $_GET['hostname'] ?></div>
                    </div>
                    <div class="row">
                        <div class="col-left">Địa chỉ khách sạn:</div>
                        <div class="col-right"><?php echo $_GET['address'] ?></div>
                    </div>
                    <div class="row">
                        <div class="col-left">Ngày nhận phòng:</div>
                        <div class="col-right"><?php echo $_GET['checkin'] ?></div>
                    </div>
                    <div class="row">
                        <div class="col-left">Ngày trả phòng:</div>
                        <div class="col-right"><?php echo $_GET['checkout'] ?></div>
                    </div>
                    <div class="row">
                        <div class="col-left">Loại phòng:</div>
                        <div class="col-right"><?php echo $_GET['typeroom'] ?></div>
                    </div>
                </div>
                <div class="div-bottom">
                    <h3>Chi tiết giá</h3>
                    <div class="row">
                        <div class="col-left"><?php echo number_format($_GET['price'])." X (".$_GET['night']." đêm)" ?></div>
                        <div class="col-right"><?php echo number_format($_GET['total'])." (VND)" ?></div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-left">Số tiền phải thanh toán (10%):</div>
                        <div class="col-right"><?php echo number_format($_GET['deposit'])." (VND)" ?></div>
                    </div>
                </div>
            <div>
                <form action="/vnpay_php/vnpay_create_payment.php" id="create_form" method="post">       
                    <div class="hidden">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="order_id" name="order_id" type="text" value="<?php echo $_GET['id_booking'] ?>"/>
                        </div>
                        <div class="form-group">
                            <label for="amount">Số tiền</label>
                            <input class="form-control" id="amount"
                                name="amount" type="number" value="<?php echo $_GET['deposit'] ?>"/>
                        </div>
                        <div class="form-group">
